...
//customization/extension suggestions (also in lesson plan): you're only able to click on one car while the others race against you, you can only click on one car while chasing a second, you can only click one car and need to avoid/stop so you don't hit randomly spawning obstacles, add a separate score keeper that adds points for cars whose paths have been completely cleared but deducts points for crashes and wrong clicks or adds a time bonus at the end, etc.
